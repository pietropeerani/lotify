import type { StationCardProps } from "../types/stationCard";

export default function StationCard({ props, square = false, onClick }: StationCardProps) {
    const {
    ...
    return (
        <div
            onClick={onClick}
            className="group font-mono select-none cursor-pointer"
        >
            <div
